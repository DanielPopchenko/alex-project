			...
			<div className='w-screen bg-gray-30 px-10 pt-5 flex '>
				...
				<div className='w-[45%] p-5'>
					<p className='text-xl mb-4'>
						Count on House&Windows Cleaning to provide a superior window washing
						experience. We will make the glass in your home or business show its
						Quality and Shine! We will remove the dirt and grime you can't see
						with our professional pressure washing services.
					</p>

					<h1 className='text-4xl mb-4'>Our qualities:</h1>
				...
				<div className='w-[55%] p-5 text-center'>
					<h1 className='text-5xl mb-14'>Gallery:</h1>
